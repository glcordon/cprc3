    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.services.update", [$service->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('service_code') ? 'is-invalid' : '' }}" type="text" name="service_code" id="service_code" value="{{ old('service_code', $service->service_code) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_billable') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="is_billable" id="is_billable" value="1" {{ $service->is_billable || old('is_billable', 0) === 1 ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_code') ? 'is-invalid' : '' }}" type="text" name="short_code" id="short_code" value="{{ old('short_code', $service->short_code) }}" required>
