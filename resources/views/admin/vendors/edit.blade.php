    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vendors.update", [$vendor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vendor_name') ? 'is-invalid' : '' }}" type="text" name="vendor_name" id="vendor_name" value="{{ old('vendor_name', $vendor->vendor_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vendor_phone') ? 'is-invalid' : '' }}" type="text" name="vendor_phone" id="vendor_phone" value="{{ old('vendor_phone', $vendor->vendor_phone) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vendor_email') ? 'is-invalid' : '' }}" type="email" name="vendor_email" id="vendor_email" value="{{ old('vendor_email', $vendor->vendor_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vendor_address_1') ? 'is-invalid' : '' }}" type="text" name="vendor_address_1" id="vendor_address_1" value="{{ old('vendor_address_1', $vendor->vendor_address_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vendor_address_2') ? 'is-invalid' : '' }}" type="text" name="vendor_address_2" id="vendor_address_2" value="{{ old('vendor_address_2', $vendor->vendor_address_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vendor_city') ? 'is-invalid' : '' }}" type="text" name="vendor_city" id="vendor_city" value="{{ old('vendor_city', $vendor->vendor_city) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vendor_state') ? 'is-invalid' : '' }}" type="text" name="vendor_state" id="vendor_state" value="{{ old('vendor_state', $vendor->vendor_state) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vendor_zip') ? 'is-invalid' : '' }}" type="text" name="vendor_zip" id="vendor_zip" value="{{ old('vendor_zip', $vendor->vendor_zip) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('is_active') ? 'is-invalid' : '' }}" name="is_active" id="is_active">
                    ...
                    @foreach(App\Vendor::IS_ACTIVE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('is_active', $vendor->is_active) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('services') ? 'is-invalid' : '' }}" name="services[]" id="services" multiple required>
                    @foreach($services as $id => $services)
                        <option value="{{ $id }}" {{ (in_array($id, old('services', [])) || $vendor->services->contains($id)) ? 'selected' : '' }}>{{ $services }}</option>
                    @endforeach
                </select>
